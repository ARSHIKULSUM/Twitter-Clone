...
export default function Tweet(){
    ...
    function postTweet(){
        ...
        axios.post("http://localhost:3000/user", {id: tweets.length+1, name: val.name, username: val.email, desc: text, image:"https://www.shutterstock.com/image-vector/no-image-available-icon-template-260nw-1036735678.jpg"})
